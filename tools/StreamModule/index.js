...
export class StreamModule extends SoundModule {
   ...
   * @param {(stream: MediaStream) => any} [streamCallback] This argument is invoked on streaming.
   * @param {(error: any) => any} [errorCallback] This argument is invoked when error occurs on streaming.
   ...
   * @param {MediaStreamAudioDestinationNode} destination This argument is the array for changing the default connection.
   ...
   * @override
   */
  start(destination, processCallback) {
    ...
    const start = (stream, destination, processCallback) => {
    ...
    navigator.mediaDevices
      ...
      .then((stream) => {
        ...
        start(stream, destination, processCallback);
