...
export class Listener extends Effector {
  ...
  constructor(context, bufferSize) {
    ...
    if (
      this.listener.forwardX instanceof AudioParam &&
      ...
      switch (k) {
        ...
        case "z":
          ...
          if (!isNaN(v)) {
            ...
            if (
              this.listener.positionX instanceof AudioParam &&
              this.listener.positionY instanceof AudioParam &&
              this.listener.positionZ instanceof AudioParam
            ) {
